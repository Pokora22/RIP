...
namespace Sisus
{
	...
	public static class StringUtils
	{
		...
		public static string GetDigitsInText(string input)
		{
		...
		private static string ToStringInternal(object target)
		{
			...
			try
			{
				...
				if(!string.Equals(toStringResult, type.ToString(), StringComparison.Ordinal))
				{
					...
					//if(!string.Equals(toStringResult, type.ToString(), StringComparison.Ordinal)) { Debug.LogWarning("Ignoring "+ type.Name+".ToString() result because length "+ toStringResult.Length+" > "+ MaxToStringResultLength+":\n"+toStringResult); }
					#endif
		...
		public static string TypeToString(object target)
		{
			if(target == null)
			{
				return "null";
		...
		public static string TypesToString(IList list, string delimiter = ",")
		{
			if(list == null)
			{
				return "null";
		...
		public static string ToString(IList list, string delimiter = ", ")
		{
			if(list == null)
			{
				return "null";
			...
			for(int n = 0; n < lastIndex; n++)
			{
				builder.Append(ToStringInternal(list[n]));
				builder.Append(delimiter);
			}
		...
		public static string ToString(IDictionary collection, string delimiter = ", ")
		{
			if(collection == null)
			{
				return "null";
			...
			{
				builder.Append(ToStringInternal(entry));
				builder.Append(delimiter);
			}
		...
		public static string ToString(IEnumerable collection, string delimiter = ", ")
		{
			if(collection == null)
			{
				return "null";
		...
		public static string ToString(IEnumerable<Object> collection, string delimiter = ", ")
		{
			if(collection == null)
			{
				return "null";
		...
		public static string ToString(Delegate del)
		{
		...
		public static void ToString(Delegate del, ref StringBuilder builder)
		{
			var target = del.Target;
			if(target != null)
			{
		...
		internal static string ToString([NotNull]Type type, char namespaceDelimiter)
		{
			...
			{
				builder.Append(',');
				//builder.Append(ToString(genericTypes[n], '\0'));
		...
		public static string CountToString(ICollection collection)
		{
			return collection == null ? "null" : ToString(collection.Count);
		}
