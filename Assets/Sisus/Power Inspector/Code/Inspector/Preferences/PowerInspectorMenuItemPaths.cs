namespace Sisus
{
	public class PowerInspectorMenuItemPaths
	{
		...
		public const string RatePowerInspector = Base + "Rate Power Inspector";

		//public const string Documentation = Base + "Help/Documentation";
		...
		public const int DocumentationPriority = 101;
		...
		//public const int DocumentationPriority = 400;
