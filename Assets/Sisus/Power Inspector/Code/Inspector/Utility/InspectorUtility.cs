...
namespace Sisus
{
	...
	public static class InspectorUtility
	{
		...
		private static void UpdateDimensions(IInspectorDrawer inspectorDrawer, ISplittableInspectorDrawer splittable)
		{
			...
			if(splittable != null && splittable.ViewIsSplit)
			{
				...
				view.State.UpdateDimensions(false, inspectorWindowRect, view.ToolbarHeight, view.PreviewAreaHeight);
