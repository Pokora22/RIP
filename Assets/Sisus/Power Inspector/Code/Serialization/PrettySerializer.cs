...
namespace Sisus
{
	...
	public static class PrettySerializer
	{
		...
		{
			return target as MonoBehaviour == null && target as ScriptableObject == null && target as GameObject == null;
		}
		...
		public static bool IsSerializedReference(string stringData)
		{
			...
			var asset = UnityEditor.AssetDatabase.GetMainAssetTypeAtPath(stringData);
			if(asset != null)
			{
				return true;
			}
