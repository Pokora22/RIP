...
namespace Sisus
{
	//given a collection, returns its size
	public delegate object GetSize(object collection);

	//sets collection size to given value
	public delegate void SetSize(ref object collection, object size);
