...
namespace Sisus
{
	...
	public static class ContextMenuUtility
	{
		...
		private static void OnPropertyContextMenuOpen(GenericMenu menu, SerializedProperty property)
		{
			...
			var lastSelectedInspector = InspectorUtility.ActiveManager.LastSelectedActiveOrDefaultInspector();
				...
				switch(property.type)
				{
					...
					case "Vector3":
							...
							()=>
							{
								...
								{
									if(string.Equals("m_LocalScale", property.name, StringComparison.Ordinal))
									{
										#if DEV_MODE
