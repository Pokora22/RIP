...
namespace Sisus
{
	...
	public interface IDrawerProvider
	{
		...
		/// </summary>
		/// <param name="fieldAttribute"> The defining PropertyAttribute on the field or property. </param>
		/// <param name="value"> The initial cached value of the drawer. </param>
		/// <param name="fieldType"> The type of the field or property. </param>
		/// <param name="memberInfo"> (Optional) LinkedMemberInfo for the field, property or parameter that the created drawer represents. </param>
		/// <param name="parent"> (Optional) The parent drawer of the created drawer. </param>
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IDrawer GetForPropertyDrawer([NotNull]PropertyAttribute fieldAttribute, [CanBeNull]object value, [NotNull]Type fieldType, [CanBeNull]LinkedMemberInfo memberInfo, [CanBeNull]IParentDrawer parent, [CanBeNull]GUIContent label, bool readOnly);
		...
		/// <returns> The drawer instance, ready to be used. This will never be null. </returns>
		[NotNull]
		IPropertyDrawerDrawer GetForPropertyDrawer(Type drawerType, [CanBeNull]PropertyAttribute fieldAttribute, [CanBeNull]object value, [CanBeNull]LinkedMemberInfo memberInfo, [CanBeNull]IParentDrawer parent, [CanBeNull]GUIContent label, bool readOnly);
