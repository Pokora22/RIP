...
namespace Sisus.Attributes
{
	...
	/// </summary>
	public sealed class DrawerForDecoratorDrawerAttribute : DrawerForBaseAttribute
	{
		...
		public DrawerForDecoratorDrawerAttribute([NotNull]Type setType) : base(false)
		{
			type = setType;
		...
		internal DrawerForDecoratorDrawerAttribute([NotNull]Type setType, bool setIsFallback) : base(setIsFallback)
		{
			type = setType;
