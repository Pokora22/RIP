...
namespace Sisus
{
	public static class ComponentDrawerUtility
	{
		...
		public static void NameByType(IComponentDrawer componentDrawer)
		{
		...
		public static void NameByType(GameObject target, Component component)
		{
			if(target != null)
			{
				...
				else
				{
					...
					{
						nameFromType = spriteRenderer.sprite == null ? "SpriteRenderer" : spriteRenderer.sprite.name;
					}
					else
					{
						...
						{
							nameFromType = component.GetType().Name;
						}
					}
				}
