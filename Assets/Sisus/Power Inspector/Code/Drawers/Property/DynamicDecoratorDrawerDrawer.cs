...
namespace Sisus
{
	public abstract class DynamicDecoratorDrawerDrawer : ReadOnlyTextDrawer, IDecoratorDrawerDrawer, IShowInInspectorIf
	{
		...
		protected override void Setup(string setValue, Type setValueType, LinkedMemberInfo setMemberInfo, IParentDrawer setParent, GUIContent setLabel, bool setReadOnly)
		{
			...
			passedLastShowInInspectorIfTest = setParent == null || showInInspectorIf.ShowInInspector(setParent.Type, setParent.GetValue(), setMemberInfo == null ? null : setMemberInfo.MemberInfo);
		...
		/// <inheritdoc />
		public abstract bool ShowInInspector([NotNull]Type containingClassType, [CanBeNull]object containingClassInstance, [CanBeNull]MemberInfo classMember);
