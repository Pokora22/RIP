...
namespace Sisus
{
	...
	public class ScriptReferenceDrawer : ParentFieldDrawer<MonoScript>
	{
		...
		public static ScriptReferenceDrawer Create(MonoScript monoScript, IParentDrawer parent, bool readOnly)
		{
		...
		protected override void Setup(MonoScript monoScript, Type setValueType, LinkedMemberInfo setMemberInfo, IParentDrawer setParent, GUIContent setLabel, bool setReadOnly)
		{
			...
			base.Setup(monoScript, setValueType, setMemberInfo, parent, setLabel == null ? GUIContentPool.Create("Script") : setLabel, setReadOnly);
		}
		...
		protected override void DoBuildMembers()
		{
			...
			members[0] = ObjectReferenceDrawer.Create(Value, Types.MonoScript, this, GUIContent.none, false, ReadOnly);
		}
