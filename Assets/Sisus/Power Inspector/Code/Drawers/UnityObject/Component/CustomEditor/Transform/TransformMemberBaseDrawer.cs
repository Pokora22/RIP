			...
			if(firstTransform != null && firstTransform.IsPrefabInstance())
			{
				Func<bool> hasUnappliedChanges = ()=>
				{
					...
					if(mods != null)
					{
						...
						{
							if(string.Equals(mods[n].propertyPath, XPropertyPath(), StringComparison.Ordinal))
							{
								return true;
							}
						}
				...
				hasUnappliedChanges = ()=>
				{
					...
					if(mods != null)
					{
						for(int n = mods.Length - 1; n >= 0; n--)
						{
							if(string.Equals(mods[n].propertyPath, YPropertyPath(), StringComparison.Ordinal))
							{
								return true;
							}
						}
				...
				hasUnappliedChanges = ()=>
				{
					...
					if(mods != null)
					{
						for(int n = mods.Length - 1; n >= 0; n--)
						{
							if(string.Equals(mods[n].propertyPath, ZPropertyPath(), StringComparison.Ordinal))
							{
								return true;
							}
						}
