...
namespace Sisus
{
	public interface IReorderableParent : IParentDrawer
	{
		...
		/// <summary>
		/// Returns false if member in question is not reorderable or a valid
		/// Drag N Drop subject for this parent.
		/// E.g. in the case of an int array, returns false resize fields
		/// but true for all IntDrawer.
		/// </summary>
		/// <param name="member">
		...
		/// <summary>
		/// Returns false if subject in question is not reorderable or a valid
		/// Drag N Drop subject for this parent.
		/// E.g. in the case of an int array, returns false resize fields
		/// but true for all IntDrawer.
		/// </summary>
