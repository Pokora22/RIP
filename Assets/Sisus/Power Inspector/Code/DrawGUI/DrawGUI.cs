...
namespace Sisus
{
	public abstract class DrawGUI
	{
		...
		public static bool EditingTextField
		{
			...
			set
			{
				...
				if(InspectorUtility.ActiveManager != null && InspectorUtility.ActiveManager.SelectedInspector != null)
				{
					...
					{
						#if DEV_MODE && PI_ASSERTATIONS
						if(EditorWindow.focusedWindow != null && !ReferenceEquals(EditorWindow.focusedWindow, InspectorUtility.ActiveInspectorDrawer))
		...
		{
			DrawSelectionOrFocusedControlRect(rect, InspectorUtility.Preferences.theme.SelectedLineIndicator);
		}
		...
		public static void DrawEdgeSelectionIndicator(Rect rect)
		{
			...
			rect.y -= 1f;
			rect.height += 1f;
			Platform.Active.GUI.ColorRect(rect, InspectorUtility.Preferences.theme.SelectedLineIndicator);
		}
		...
		public static void DrawControlSelectionIndicator(Rect rect)
		{
			...
			DrawRect(rect, InspectorUtility.Preferences.theme.SelectedLineIndicator);
		}
		...
		public abstract void Label(Rect position, GUIContent label, GUIStyle style);
