...
{
	/// <summary>
	/// A class that can be extended to provide Drawer related to third party plugins.
	/// They should provide the ability to detect whether or not the plugin in question is currently "active",
	/// meaning the Drawer related to it should currently be used.
	/// </summary>
	public abstract class DrawerFromPluginProvider
	{
		...
		/// <summary> Is the plugin currently installed? </summary>
		/// <value> True if plugin is installed, false if not. </value>
		public abstract bool IsActive { get; }

		/// <summary> Adds IFieldGUIInstruction types related to the plugin to the Dictionary. </summary>
		/// <param name="fieldDrawer"> [in,out] Dictionary of field drawers where key is exact field type and value is Drawer type. </param>
		...
		/// <param name="decoratorDrawerDrawer"> [in,out] Dictionary of DecoratorDrawer drawers where key is exact field type and value is Drawer type. </param>
		...
		/// <param name="propertyDrawerDrawerByAttributeType"> [in,out] Dictionary of PropertyDrawer drawers where key is exact attribute type and value is Drawer type. </param>
		///  <param name="propertyDrawerDrawerByFieldType"> [in,out] Dictionary of PropertyDrawer drawers where key is exact field type and value is Drawer type. </param>
		...
		/// <param name="assetDrawerByType"> [in,out] Dictionary of asset drawers where key is exact asset type and value is Drawer type. </param>
		///  <param name="assetDrawerByExtension"> [in,out] Dictionary of asset drawers where key is file extension (including leading dot) and value is Drawer type. </param>
